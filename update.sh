...
if [ g"${gitSource}" = g"gitee" ]; then
    ...
    wget -qc "https://gitee.com/SAOJSM/OneManager-php/repository/archive/${branch}.zip"
    unzip -qo "${branch}.zip"

    cd "SAOJSM-OneManager-php-"*
    if [ $? -eq 0 ]; then
    ...
    #https://github.com/SAOJSM/OneManager-php/archive/refs/heads/master.zip
    #wget -qc "https://github.com/SAOJSM/OneManager-php/archive/refs/heads/${branch}.zip"
    #unzip "${branch}.zip"
    #$url = 'https://github.com/' . $auth . '/' . $project . '/tarball/' . urlencode($branch) . '/';
    wget -qc "https://github.com/SAOJSM/OneManager-php/tarball/${branch}/" -O "${branch}.tar.gz"
